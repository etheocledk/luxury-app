                    ...
                    <div key={place.id}>
                        <div className="flex justify-between items-center">
                            <div className="flex space-x-2">
                                <div>
                                    <Image
                                        src={place.default_image_url || "https://dummyimage.com/300x300"}
                                        alt={place.title}
                                        width={300}
                                        height={300}
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">{truncateText(place.description, 80)}</p>
                                </div>
                            </div>
                            <div>
                                <Link href={`/dashboard/places/edit/${place.id}`} className="px-2 py-1 border border-gray rounded-[5px] hover:bg-black hover:text-white">Edit</Link>
                            </div>
                        </div>
                        <hr className="my-2" />
                    </div>
